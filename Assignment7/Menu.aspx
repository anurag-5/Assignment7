<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Assignment7.Menu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 pb-5 text-center">
      <h3 class="text-center quicksand-font text-uppercase">Appetizer</h3>
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 pb-5 text-center">
      <h3 class="text-center quicksand-font text-uppercase">First Course</h3>
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 pb-5 text-center">
      <h3 class="text-center quicksand-font text-uppercase">Main Course</h3>
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 pb-5 text-center">
      <h3 class="text-center quicksand-font text-uppercase">Dessert</h3>
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 pb-5 text-center">
      <h3 class="text-center quicksand-font text-uppercase">Wine</h3>
